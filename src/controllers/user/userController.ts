...
//services
import { getUserBySlug, deleteUser } from "../../services/user.service";
...
import { Cart, Product, Review, User } from "../../models";
...
export const getProfile = asyncHandler(
  async (req: IAuthRequest, res: Response, next: NextFunction) => {
    ...
    if (!user)
      return next(
        new ErrorResponse(errorMessages("auth", "username/password"), 404)
      );
